    ...
    render() {
        if(this.props.is_login){
            return (
                <section id="signup">
                    <hr/>
                    <h3 className="text-body text-center">Edit Buyer Profile</h3>
                    <hr/>
                    <div className="row justify-content-center">
                        <form className="form col-lg-3 col-md-4 col-sm-6 col-10 my-4 py-5 px-3 shadow-lg" onSubmit={e => e.preventDefault()} role="form">
                            ...
                            <div className="form-group">
                                <button type="submit" onClick={() => this.doEditBuyer()} className="btn btn-primary btn-block">Update</button>
                            </div>
                        </form>
                    </div>
                </section>
...
export default connect("is_login,user_id,user_name,password,display_name,email,display_picture,description,created_at,role,token",actions)(withRouter(EditProfileBuyer));
