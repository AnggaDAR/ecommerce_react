...
class SignupSeller extends Component {
    doSignup = () =>{
        this.props.postSignupSeller().then(
            () => {
    ...
    render() {
        if(!this.props.is_login){
            return (
                <section id="signup">
                    <hr/>
                    <h3 className="text-body text-center">Seller's Signup Form</h3>
                    <hr/>
                    <div className="row justify-content-center">
                        <form className="form col-lg-3 col-md-4 col-sm-6 col-10 my-4 py-5 px-3 shadow-lg" onSubmit={e => e.preventDefault()} role="form">
                            ...
                            <div className="form-group">
                                <textarea id="description" placeholder="Description" name="description" className="form-control form-control-sm" type="text" required="" onChange={e => this.props.setField(e)}></textarea>
                            </div>
                            <div className="form-group">
...
export default connect("is_login",actions)(withRouter(SignupSeller));
