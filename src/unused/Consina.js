...
class Consina extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.getProductByBrand("Consina")
    }
    ...
    render() {
        return (
            <section id="product">
                {/* <Category/> */}
                <hr/>
                <h3 className="text-secondary text-center">Products in Consina's Brand</h3>
                <hr/>
